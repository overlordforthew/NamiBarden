...
const COURSES = {
  'course-1': {
    ...
    lessons: [
      ...
      { id: 'lesson-6',  title: 'デートがうまくいかない理由', desc: 'デートの準備で無意識にやっている「遺伝子の行動」とは？外見やテクニックに頼るデートから卒業するための心の知恵を学びます。' },
      { id: 'lesson-7',  title: '運命の相手はどこに？', desc: '「運命の人」という幻想を手放し、本当に心が通い合う相手を見つける心の在り方を学びます。' },
      { id: 'lesson-8',  title: '魅力的な自分を作る５つの心得', desc: '相手を「探す」前に、自分を「磨く」ことが先決。仕事・趣味・日常の中で内面から魅力を高める5つの実践法を紹介します。' },
      { id: 'lesson-9',  title: 'パートナーと心を通わせるコツ (1)', desc: 'ミラーリングや傾聴テクニックだけでは心はつながらない。「今ここ」に意識を置き、本当の意味で相手のために存在するコミュニケーション術・前編。' },
      { id: 'lesson-10', title: 'パートナーと心を通わせるコツ (2)', desc: '日常の中で深いつながりを育てる具体的な実践法。スモールトークからビッグトークへ、心を通わせる会話の質を高めます。' },
      ...
      { id: 'lesson-11', title: 'ビジョンを描けば現実になる (1)', desc: '「引き寄せの法則」は本当に機能するのか？漠然と願うだけでは叶わない理由と、ビジョンをクリアにする重要性を学びます。' },
      { id: 'lesson-12', title: 'ビジョンを描けば現実になる (2)', desc: '実際にビジョンボードを作るワーク。具体的に夢を描き、パートナーシップの理想を形にしていきます。' }
    ]
  },
  'course-2': {
    name: '愛を深める心の授業',
