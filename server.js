...
const COURSES = {
  'course-1': {
    ...
    lessons: [
      ...
      { id: 'lesson-11', title: '引き寄せの法則は本当 (1)', desc: '「引き寄せの法則」は本当に機能するのか？漠然と願うだけでは叶わない理由と、ビジョンをクリアにする重要性を学びます。' },
      { id: 'lesson-12', title: '引き寄せの法則は本当 (2)', desc: '実際にビジョンボードを作るワーク。具体的に夢を描き、パートナーシップの理想を形にしていきます。' }
    ]
  },
  'course-2': {
    name: '愛を深める心の授業',
